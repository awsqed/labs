...
Adding as Step 23 (File Permissions→24, Cleanup→25).

**1. Update Constants:**
```bash
readonly TOTAL_STEPS=25  # Line 48

declare -a STEP_NAMES=(   # Lines 62-88
    ""
    "System Updates"
    # ... existing ...
    "Log Monitoring"
    "Fail2Ban"           # Step 23
    "File Permissions"   # Step 24
    "Cleanup"            # Step 25
)
```

**2. Implementation (~line 1975):**
```bash
# ============================================================================
# STEP 23: FAIL2BAN
# ============================================================================
